export default function templateDeveloper (developer, allBlocks) {
  ...
  row.innerHTML = `
  	<div class="table__cell table__cell--builder" data-index="${developer.dataIndex}">${developer.builderName}</div>
    ...
    <div class="table__cell table__cell--like">Добавить в избранное</div>
   	`;
